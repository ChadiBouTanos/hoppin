...
export function SupportFooterBanner() {
  return (
    <div className="support-banner mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
      <div className="support-banner-card flex flex-col gap-3 rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
